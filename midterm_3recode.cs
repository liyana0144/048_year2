...
namespace ConsoleApp1_recode
{
    class Program
    {
        ...
        static void SelectFlower(string decide, FlowerStore flowerStore)
        {
            string selectFlower;
        ...
        static void PrintContinueOrExit(string decide, FlowerStore flowerStore)
        {
